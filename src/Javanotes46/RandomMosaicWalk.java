...
public class RandomMosaicWalk {
    ...
    /**
     * Change the color to be more green
     */
    static void changeToGreenColor(int rowNum, int colNum){
        if (Mosaic.getGreen(rowNum, colNum) + 25 > 255){
            Mosaic.setColor(rowNum,colNum,Mosaic.getRed(rowNum, colNum),255,Mosaic.getBlue(rowNum, colNum));
        } else {
